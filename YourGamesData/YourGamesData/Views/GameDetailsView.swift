...
struct GameDetailsView: View {
    ...
    var body: some View {
        ...
        .overlay(
            // Overlay para mostrar la captura de pantalla en pantalla completa
            Group {
...
// Vista para mostrar la captura de pantalla en pantalla completa
struct ImageFullScreenView: View {
    ...
    var body: some View {
            ...
            AsyncImage(url: URL(string: imageURL)) { image in
                image
                    ...
                    .gesture(TapGesture().onEnded {
                        // Cerrar la vista de pantalla completa al tocar la imagen
                        onTap()
                    })
            } placeholder: {
                ProgressView()
        ...
        .navigationBarHidden(true) // Ocultar la barra de navegación en la vista de pantalla completa
    }
}
